# Radware CWAF Enrichment - SplunkApp Frontend

This folder contains the frontend code for the radware_cwaf_enrichment Splunk App
...
RadwareEnrichment Frontend uses [prettier](https://github.com/prettier/prettier) to ensure consistent code formatting. It is recommended
