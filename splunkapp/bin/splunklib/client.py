...
class Service(_BaseService):
    ...
    **Example**::
    ...
    def __init__(self, **kwargs):
        ...
        self._radware_cwaf_enrichment_owner = None
    ...
    @property
    def radware_cwaf_enrichment_owner(self):
        ...
        """
        if self._radware_cwaf_enrichment_owner is None:
            self._radware_cwaf_enrichment_owner = "nobody"
        return self._radware_cwaf_enrichment_owner

    @radware_cwaf_enrichment_owner.setter
    def radware_cwaf_enrichment_owner(self, value):
        """
        kvstore is refreshed, when the owner value is changed
        """
        self._radware_cwaf_enrichment_owner = value
        self.kvstore
    ...
    def kvstore(self):
        ...
        """
        self.namespace['owner'] = self.radware_cwaf_enrichment_owner
